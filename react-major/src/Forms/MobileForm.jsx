...
import { HandleData } from '../Features/Mobile/MobileSlice';
...
const MobileForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:7000/api/mobile/add" ,{
        method: "POST",
        credentials:'include',
        body: formData, 
      });
  ...
  useEffect(() => {
	...
	return (
      ...
      <div className={styles.formContainer}>
        <h2 className={styles.h2}>Mobile Details Form</h2>
        <form onSubmit={handleSubmit} className={styles.vehicleForm}>
          ...
          <div className={styles.formRow}>
            <div className={styles.formColumn}>
              ...
              <textarea
                placeholder='Enter your info like proccessor, ram, model name etc...'

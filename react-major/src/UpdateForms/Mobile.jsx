// MobileUpdateModal.jsx
import {React, useState} from 'react';
import s from './Main.module.css';
import { indianCities } from '../Utils/IndianCities';
import { mobileBrands } from '../Utils/MobileBrands';

export default function MobileUpdateModal({ data, onClose, onSubmit }) {
  ...
  return (
    <div className={s.overlay} onClick={onClose}>
      <div className={s.modal} onClick={e => e.stopPropagation()}>
        <h2 className={s.title}>Update Mobiles Details</h2>
            ...
            <select
              ...
              onChange={handleChange}>
                <option value="select brand">Select Brand</option>
                {
                  ...
                  mobileBrands.map((ele) => <option value={ele}>{ele}</option>)
                }
            </select>
          </label>
